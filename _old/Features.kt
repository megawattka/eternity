...
import org.mgwt.eternity.config.features.About
import org.mgwt.eternity.utils.ConfigUtils.asStructuredText
...
//        val modName = if (TimeUtils.isAprilFoolsDay) "SkyHanni".reversed() else "SkyHanni"
        return "Eternity ${Eternity.VERSION} by §cmegawattka§r, config by §5Moulberry §rand §5nea89".asStructuredText()
    }
